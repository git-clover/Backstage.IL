...
At Backstage.IL, we are committed to maintaining the security of our ecosystem. Our policy is to ensure that we do not introduce vulnerabilities and that any security issues are addressed promptly and responsibly. We appreciate your help in improving the security of Backstage.IL and thank you for your responsible disclosure.
...
## To report a security bug, please follow these guidelines:
  ...
  * Handling the Report:
        Backstage.IL will confirm the problem and determine the affected versions.
...
To enhance security when using Backstage.IL, we recommend following these steps:
...
### Thank you for your commitment to the security of Backstage.IL. Your efforts help us maintain a safe and reliable ecosystem.
