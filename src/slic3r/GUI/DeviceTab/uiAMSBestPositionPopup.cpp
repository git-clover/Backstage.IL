...
void UiStyledSwitchPanel::OnPaint(wxPaintEvent& event)
{
    ...
    dc.SetTextForeground(wxColour("#000d1f"));
    // dc.SetFont(font);
               ...
               wxDefaultPosition, wxDefaultSize, wxCAPTION | wxCLOSE_BOX)
{
    ...
    linkwiki->SetForegroundColour(wxColour("#003887")); // Orca: accent green
    ...
    m_buttonClose->SetBackgroundColor(wxColour("#003887")); // Orca: accent green
