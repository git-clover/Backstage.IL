...
void NotificationManager::PopNotification::use_bbl_theme()
{
 ...
 //   OldStyle.Colors[ImGuiCol_Text]     = m_TextColor;
	...
	m_HyperTextColor = m_is_dark ? ImVec4(0, 0.31, 0.859, 1) : ImVec4(0, 0.31, 0.859, 1);
	m_HyperTextColorHover = m_is_dark ? ImVec4(0   / 255.f, 77  / 255.f, 185 / 255.f, 1) : ImVec4(0.f, 129.f / 255.f, 114.f / 255.f, 1); //#0061E9 / #003A86;
