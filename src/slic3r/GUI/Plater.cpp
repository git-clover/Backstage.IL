...
void Sidebar::priv::flush_printer_sync(bool restart)
{
    ...
    //btn_sync_printer->SetBackgroundColorNormal((*counter_sync_printer & 1) ? "#F8F8F8" :"#003887");
...
{
    StateColor not_synced_colour(std::pair<wxColour, int>(wxColour("#003887"), StateColor::Normal));
    ...
    : wxPanel(parent, wxID_ANY, wxDefaultPosition, wxSize(39 * wxGetApp().em_unit(), -1)), p(new priv(parent))
{
    ...
    // add printer
    {
        ...
        struct PanelColors {
            ...
            wxColour bd_hover  = "#003887";
            wxColour bd_focus  = "#003887";
        };
        ...
        */
        ...
        StateColor btn_sync_bd_col(
                std::pair<wxColour, int>(wxColour("#003887"), StateColor::Pressed),
                std::pair<wxColour, int>(wxColour("#003887"), StateColor::Hovered),
    ...
    text_ctrl->Bind(wxEVT_SET_FOCUS, [this](wxFocusEvent& e) {
        ...
        p->m_search_bar->SetBorderColor(wxColour("#003887"));
...
void Plater::priv::apply_color_mode()
{
    ...
    wxColour sash_color = is_dark ? wxColour(0, 13, 31) : wxColour(206, 206, 206);
