...
public:
    HoverLabel(wxWindow *parent, const wxString &label) : wxPanel(parent, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxBORDER_NONE)
    {
        ...
        m_brace_left->SetForegroundColour(StateColor::darkModeColorFor(wxColour("#171F29")));
        m_brace_left->Hide();

        m_count = new wxStaticText(this, wxID_ANY, "", wxDefaultPosition, wxDefaultSize, wxBORDER_NONE);
        m_count->SetFont(Label::Body_13.Bold());
        m_count->SetForegroundColour(StateColor::darkModeColorFor(wxColour("#171F29")));
        m_count->Hide();
        ...
        m_brace_right->SetForegroundColour(StateColor::darkModeColorFor(wxColour("#171F29")));
        m_brace_right->Hide();
    ...
    void sys_color_changed()
    {
        ...
        for (wxStaticText *t : {m_brace_left, m_count, m_brace_right})
            t->SetForegroundColour(StateColor::darkModeColorFor(wxColour("#171F29")));
        m_hover_btn->SetBackgroundColour(extruder_group_chip_bg());
        Refresh();
    }
...
void Sidebar::priv::flush_printer_sync(bool restart)
{
    ...
    //btn_sync_printer->SetBackgroundColorNormal((*counter_sync_printer & 1) ? "#F8F8F8" :"#004fbd");
...
public:
        ...
        : PopupWindow(extruder, wxBORDER_NONE | wxPU_CONTAINS_CONTROLS)
    {
        ...
        msg->SetForegroundColour("#171F29");
    ...
    : StaticGroup(parent, wxID_ANY, wxString())
{
    ...
    label_diameter->SetForegroundColour(StateColor::darkModeColorFor(wxColour("#171F29")));
    ...
    label_flow->SetForegroundColour(StateColor::darkModeColorFor(wxColour("#171F29")));
    ...
    label_ams->SetForegroundColour(StateColor::darkModeColorFor(wxColour("#171F29")));
    ...
    ams_not_installed_msg->SetForegroundColour(StateColor::darkModeColorFor(wxColour("#171F29")));
    ...
    : wxPanel(parent, wxID_ANY, wxDefaultPosition, wxSize(39 * wxGetApp().em_unit(), -1)), p(new priv(parent))
{
    ...
    // add printer
    {
        ...
        struct PanelColors {
            ...
            wxColour bd_hover  = "#004fbd";
            wxColour bd_focus  = "#004fbd";
        };
        ...
        */
        ...
        StateColor btn_sync_bd_col(
                std::pair<wxColour, int>(wxColour("#004fbd"), StateColor::Pressed),
                std::pair<wxColour, int>(wxColour("#004fbd"), StateColor::Hovered),
    ...
    text_ctrl->SetForegroundColour(wxColour("#171F29"));
    ...
    text_ctrl->Bind(wxEVT_SET_FOCUS, [this](wxFocusEvent& e) {
        ...
        p->m_search_bar->SetBorderColor(wxColour("#004fbd"));
