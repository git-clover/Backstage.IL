    ...
    : wxPanel(parent, wxID_ANY, wxDefaultPosition, wxDefaultSize)
{
    ...
    this->logo = ScalableBitmap(this, Slic3r::var("Backstage.IL_192px.png"), wxBITMAP_TYPE_PNG);
        ...
        wxDefaultSize, /*wxCAPTION*/wxDEFAULT_DIALOG_STYLE)
{
    ...
    // logo
    m_logo_bitmap = ScalableBitmap(this, is_dark ? "Backstage.IL_about_dark" : "Backstage.IL_about", 125);
    ...
    text_list.push_back(_L("Backstage.IL began in that same spirit, drawing from PrusaSlicer, BambuStudio, SuperSlicer, and CuraSlicer. But it has since grown far beyond its origins — introducing advanced calibration tools, precise wall and seam control and hundreds of other features."));
    text_list.push_back(_L("Today, Backstage.IL is the most widely used and actively developed open-source slicer in the 3D printing community. Many of its innovations have been adopted by other slicers, making it a driving force for the entire industry."));
    ...
    wxStaticText *html_text = new wxStaticText(this, wxID_ANY, "Copyright(C) 2026 Backstage.IL Pte Ltd All Rights Reserved", wxDefaultPosition, wxDefaultSize);
    ...
    m_html = new wxHtmlWindow(this, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxHW_SCROLLBAR_NEVER /*NEVER*/);
      {
          ...
          const auto text = from_u8(
              ...
              "<p style=\"text-align:left\"><a style=\"color:#004fbd\" href=\"https://www.orcaslicer.com\">https://www.orcaslicer.com</ a></p>"
              "</body>"
              "</html>")
            ).str());
          m_html->SetPage(text);
