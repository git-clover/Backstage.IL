    ...
    : wxControl()
{
    ...
    Bind(wxEVT_PAINT, [this](wxPaintEvent&) {
        ...
        dc.SetBackground(wxBrush(wxColour(38, 51, 69)));
        dc.Clear();
...
{
    dc.SetBrush(wxBrush(wxColour(38, 51, 69)));
...
void BBLTopbarArt::DrawButton(wxDC& dc, wxWindow* wnd, const wxAuiToolBarItem& item, const wxRect& rect)
{
    ...
    if (!(item.GetState() & wxAUI_BUTTON_STATE_DISABLED))
    {
        ...
        {
            dc.SetPen(wxPen(StateColor::darkModeColorFor("#004fbd"))); // ORCA
            dc.SetBrush(wxBrush(StateColor::darkModeColorFor("#004fbd"))); // ORCA
            dc.DrawRectangle(rect);
        }
