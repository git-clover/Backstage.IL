...
const ImVec4 ImGuiWrapper::COL_GREEN_LIGHT       = { 0   / 255.f, 97 / 255.f, 233 / 255.f, 0.25f }; // ORCA used on various places like text selection bg. Replaced with orca color
