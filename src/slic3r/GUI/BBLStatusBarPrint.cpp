    ...
    , m_sizer(new wxBoxSizer(wxHORIZONTAL))
{
    ...
    StateColor btn_txt_white(std::pair<wxColour, int>(wxColour("#FFFFFE"), StateColor::Disabled), std::pair<wxColour, int>(wxColour(0, 13, 31), StateColor::Normal));
    ...
    m_link_show_error->SetForegroundColour(wxColour("#003887"));
