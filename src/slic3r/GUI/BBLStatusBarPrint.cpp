    ...
    , m_sizer(new wxBoxSizer(wxHORIZONTAL))
{
    ...
    StateColor btn_txt_white(std::pair<wxColour, int>(wxColour("#FFFFFE"), StateColor::Disabled), std::pair<wxColour, int>(wxColour(38, 51, 69), StateColor::Normal));
    ...
    m_link_show_error->SetForegroundColour(wxColour("#004fbd"));
