...
ZUserLogin::ZUserLogin(std::shared_ptr<ICloudServiceAgent> cloud_agent)
    : wxDialog((wxWindow*) (wxGetApp().mainframe), wxID_ANY, "Backstage.IL"), m_cloud_agent(cloud_agent)
{
    ...
    if (!m_cloud_agent) {
        ...
        auto* m_message = new wxStaticText(this, wxID_ANY,
                                          _L("Cloud agent is not available. Please restart Backstage.IL and try again."),
