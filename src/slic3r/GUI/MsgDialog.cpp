...
void MsgDialog::apply_style(long style)
{
    ...
    logo->SetBitmap( create_scaled_bitmap(style & wxAPPLY        ? "completed" :
                                          ...
                                          style & wxICON_QUESTION       ? "question"    : "Backstage.IL", this, 64, style & wxICON_ERROR));
}
    ...
    , msg(temp_msg)
{
	...
	logo->SetBitmap(create_scaled_bitmap("Backstage.IL_192px_grayscale.png", this, has_code_excerpts ? 48 : /*1*/64));
...
wxBoxSizer *Newer3mfVersionDialog::get_msg_sizer()
{
    ...
    if (file_version_newer) { 
        text1 = new wxStaticText(this, wxID_ANY, _L("The 3MF file version is in Beta and it is newer than the current Backstage.IL version."));
        wxStaticText *   text2       = new wxStaticText(this, wxID_ANY, _L("If you would like to try Orca Slicer Beta, you may click to"));
        // ORCA standardized HyperLink
        HyperLink *      github_link = new HyperLink(this, _L("Download Beta Version"), "https://github.com/SoftFever/Backstage.IL/releases");
        horizontal_sizer->Add(text2, 0, wxEXPAND, 0);
        horizontal_sizer->Add(github_link, 0, wxEXPAND | wxLEFT, 5);
        
    } else {
        text1 = new wxStaticText(this, wxID_ANY, _L("The 3MF file version is newer than the current Backstage.IL version."));
        wxStaticText *text2 = new wxStaticText(this, wxID_ANY, _L("Updating your Backstage.IL could enable all functionality in the 3MF file."));
        horizontal_sizer->Add(text2, 0, wxEXPAND, 0);
    }
