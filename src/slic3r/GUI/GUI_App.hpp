...
enum Backstage.ILMenuIDs {
  Backstage.ILMenuAbout,
  Backstage.ILMenuPreferences,
};
...
public:
    ...
    std::string logo_name() const { return is_editor() ? "Backstage.IL" : "Backstage.IL-gcodeviewer"; }
