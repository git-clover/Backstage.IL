...
void DailyTipsDataRenderer::render_text(const ImVec2& start_pos, const ImVec2& size) const
{
    ...
    if (!m_data.wiki_url.empty()) {
        ...
        ImColor HyperColor = ImColor(0, 55, 133, (int)(255 * m_fade_opacity)).Value; // ORCA match color of hyperlinks
    ...
    if (ImGui::BeginChild(name.c_str(), size, false, window_flags)) {
        ...
        if (m_can_expand) {
            if (m_is_expanded) {
                ...
                ImGui::PushStyleColor(ImGuiCol_ButtonHovered, ImVec4(.0f, .0f, .0f, .0f));
                ImGui::PushStyleColor(ImGuiCol_ButtonActive, ImVec4(.0f, .0f, .0f, .0f));
                ImGui::PushStyleColor(ImGuiCol_Text, m_is_dark ? ImColor(230, 230, 230, (int)(255 * m_fade_opacity)).Value : ImColor(0, 13, 31, (int)(255 * m_fade_opacity)).Value);
                ...
                if (ImGui::IsMouseHoveringRect(btn_pos, btn_pos + expand_btn_size, true))
                {
                    ...
                    ImGui::GetWindowDrawList()->AddLine(lineStart, lineEnd, m_is_dark ? ImColor(230, 230, 230, (int)(255 * m_fade_opacity)) : ImColor(0, 13, 31, (int)(255 * m_fade_opacity)));
        ...
        // prev button
        ImColor button_text_color = m_is_dark ? ImColor(228, 228, 228, (int)(255 * m_fade_opacity)) : ImColor(0, 13, 31, (int)(255 * m_fade_opacity));
        ...
        {
            button_text_color = ImColor(0, 55, 133, (int)(255 * m_fade_opacity));
            if (ImGui::IsMouseClicked(ImGuiMouseButton_Left))
        ...
        // next button
        button_text_color = m_is_dark ? ImColor(228, 228, 228, (int)(255 * m_fade_opacity)) : ImColor(0, 13, 31, (int)(255 * m_fade_opacity));
