    ...
    m_task_type(type)
{
    ...
    auto m_btn_bg_enable = StateColor(
        ...
        std::pair<wxColour, int>(wxColour(59, 116, 189), StateColor::Hovered),
    ...
    StateColor clean_bd(std::pair<wxColour, int>(wxColour(144, 144, 144), StateColor::Disabled), std::pair<wxColour, int>(wxColour(0, 13, 31), StateColor::Enabled));
    StateColor clean_text(std::pair<wxColour, int>(wxColour(144, 144, 144), StateColor::Disabled), std::pair<wxColour, int>(wxColour(0, 13, 31), StateColor::Enabled));
        ...
        if (get_obj()) {
            if (state_cloud_task == 0 && m_job_id == get_obj()->profile_id_) {
                ...
                if (state_device == 0) {
                    ...
                    dc.SetTextForeground(wxColour(0, 55, 133));
                    DrawTextWithEllipsis(dc, get_state_device(), FromDIP(DEVICE_LEFT_PRO_INFO), left);
                }
                else if (state_device == 2)
                {
                    ...
                    if (obj_->get_curr_stage() == _L("Printing") && obj_->subtask_) {
                        ...
                        dc.SetPen(wxPen(wxColour(0, 55, 133)));
                        dc.SetBrush(wxBrush(wxColour(0, 55, 133)));
