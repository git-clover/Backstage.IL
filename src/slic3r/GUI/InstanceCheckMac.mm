...
-(void)add_observer:(NSString *)version_hash
{
	...
	//NSString *nsver = @"OtherBackstage.ILInstanceMessage" + version_hash;
	NSString *nsver = [NSString stringWithFormat: @"%@%@", @"OtherBackstage.ILInstanceMessage", version_hash];
	...
	NSString *nsver2 = [NSString stringWithFormat: @"%@%@", @"OtherBackstage.ILInstanceClosing", version_hash];
...
void send_message_mac(const std::string &msg, const std::string &version)
{
	...
	//NSString *nsver = @"OtherBackstage.ILInstanceMessage" + [NSString stringWithCString:version.c_str() encoding:[NSString defaultCStringEncoding]];
	NSString *nsver = [NSString stringWithCString:version.c_str() encoding:[NSString defaultCStringEncoding]];
	NSString *notifname = [NSString stringWithFormat: @"%@%@", @"OtherBackstage.ILInstanceMessage", nsver];
...
void send_message_mac_closing(const std::string &msg, const std::string &version)
{
	...
	//NSString *nsver = @"OtherBackstage.ILInstanceMessage" + [NSString stringWithCString:version.c_str() encoding:[NSString defaultCStringEncoding]];
	NSString *nsver = [NSString stringWithCString:version.c_str() encoding:[NSString defaultCStringEncoding]];
	NSString *notifname = [NSString stringWithFormat: @"%@%@", @"OtherBackstage.ILInstanceClosing", nsver];
	[[NSDistributedNotificationCenter defaultCenter] postNotificationName:notifname object:nil userInfo:[NSDictionary dictionaryWithObject:nsmsg forKey:@"data"] deliverImmediately:YES];
}
