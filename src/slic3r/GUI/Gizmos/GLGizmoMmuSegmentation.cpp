...
void GLGizmoMmuSegmentation::on_render_input_window(float x, float y, float bottom_limit)
{
    ...
    for (int i = 0; i < tool_ids.size(); i++) {
        ...
        ImGui::PushStyleColor(ImGuiCol_Button       , is_active ? ImVec4(0.00f, 0.31f, 0.74f, .25f) : ImVec4(0,0,0,0));         // ORCA
        ImGui::PushStyleColor(ImGuiCol_ButtonHovered, is_active ? ImVec4(0.00f, 0.31f, 0.74f, .25f) : ImVec4(.6f,.6f,.6f,.2f)); // ORCA
        ImGui::PushStyleColor(ImGuiCol_ButtonActive , is_active ? ImVec4(0.00f, 0.31f, 0.74f, .30f) : ImVec4(0,0,0,0));         // ORCA
