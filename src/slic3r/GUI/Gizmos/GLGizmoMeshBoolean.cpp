...
void GLGizmoMeshBoolean::on_render_input_window(float x, float y, float bottom_limit)
{
    ...
    auto selectable = [this](const std::string& label, bool selected, const ImVec2& size_arg) {
        ...
        if (selected || hovered) {
            ...
            ImGui::PushStyleColor(ImGuiCol_Button, { 0   / 255.f, 79  / 255.f, 189 / 255.f, 1.0f });
            ImGui::PushStyleColor(ImGuiCol_ButtonActive, { 0   / 255.f, 79  / 255.f, 189 / 255.f, 1.0f });
            ImGui::PushStyleColor(ImGuiCol_ButtonHovered, { 0   / 255.f, 79  / 255.f, 189 / 255.f, 1.0f });
        }
        else {
            ImGui::PushStyleColor(ImGuiCol_ButtonActive, { 0   / 255.f, 79  / 255.f, 189 / 255.f, 1.0f });
            ImGui::PushStyleColor(ImGuiCol_ButtonHovered, { 0   / 255.f, 79  / 255.f, 189 / 255.f, 1.0f });
