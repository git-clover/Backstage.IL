...
static const wxColour BUTTON_HOVER_COL   = wxColour(0, 79, 189);
...
static const wxColour STAGE_TEXT_COL      = wxColour(0, 79, 189);
...
void ExtruderSwithingStatus::updateBy(const DevExtderSystem* ext_system)
{
    ...
    auto state = ext_system->GetSwitchState();
    {
        if (state == DevExtderSwitchState::ES_SWITCHING)
        {
            ...
            m_switching_status_label->SetForegroundColour(StateColor::darkModeColorFor("#171F29"));
...
void PrintingTaskPanel::create_panel(wxWindow* parent)
{
    ...
    m_staticText_progress_percent->SetForegroundColour(wxColour(0, 79, 189));
    ...
    m_staticText_progress_percent_icon->SetForegroundColour(wxColour(0, 79, 189));
...
wxBoxSizer *StatusBasePanel::create_misc_control(wxWindow *parent)
{
    ...
    m_switch_fan->Bind(wxEVT_ENTER_WINDOW, [this](auto& e) {
        m_fan_panel->SetBackgroundColor(wxColour(0, 79, 189));
        });
...
wxBoxSizer* StatusBasePanel::create_filament_group(wxWindow* parent)
{
    ...
    m_title_filament_loading->SetForegroundColour(wxColour(0, 65, 155));
