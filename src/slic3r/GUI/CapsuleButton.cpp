...
static const wxColour TextNormalColor = wxColour("#000d1f");
static const wxColour TextSelectColor = wxColour("#000d1f"); // ORCA use same color on selected to improve readability

static const wxColour BorderNormalColor   = wxColour("#CECECE");
static const wxColour BorderSelectColor = wxColour("#003887");
