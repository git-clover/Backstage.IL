...
static const wxColour TextNormalColor = wxColour("#171F29");
static const wxColour TextSelectColor = wxColour("#171F29"); // ORCA use same color on selected to improve readability

static const wxColour BorderNormalColor   = wxColour("#CECECE");
static const wxColour BorderSelectColor = wxColour("#004fbd");
