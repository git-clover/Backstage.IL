...
static const wxColour TEXT_NORMAL_CLR = wxColour(0, 55, 133);
...
wxPanel *MachineInfoPanel::create_caption_panel(wxWindow *parent)
{
    ...
    m_caption_text->SetForegroundColour("#000d1f");
    ...
    : wxPanel(parent,id,pos,size,style)
{
     ...
     m_staticText_ams->SetForegroundColour("#000d1f");
     ...
     m_staticText_ams_sn->SetForegroundColour("#000d1f");
     ...
     m_staticText_ams_sn_val->SetForegroundColour("#000d1f");
     ...
     m_staticText_ams_ver->SetForegroundColour("#000d1f");
     ...
     m_staticText_ams_ver_val->SetForegroundColour("#000d1f");
     ...
     : wxPanel(parent, id, pos, size, style)
 {
     ...
     m_staticText_ext->SetForegroundColour("#000d1f");
     ...
     m_staticText_ext_val->SetForegroundColour("#000d1f");
     ...
     m_staticText_ext_sn->SetForegroundColour("#000d1f");
     ...
     m_staticText_ext_sn_val->SetForegroundColour("#000d1f");
     ...
     m_staticText_ext_ver->SetForegroundColour("#000d1f");
     ...
     m_staticText_ext_ver_val->SetForegroundColour("#000d1f");
