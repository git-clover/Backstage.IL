...
public:
    ...
    {   // ORCA draw selection background to improve consistency between platforms
        dc.SetBrush(StateColor::darkModeColorFor(wxColour("#CADAF1")));
    ...
    {   // ORCA draw focus rectangle to improve consistency between platforms
        dc.SetPen(  StateColor::darkModeColorFor(wxColour("#003887")));
        dc.DrawRectangle(rect);
    }
    ...
    {   // ORCA draw custom text to improve consistency between platforms
        ...
        dc.SetTextForeground(StateColor::darkModeColorFor(wxColour("#000d1f"))); // use same color for selected / non-selected
