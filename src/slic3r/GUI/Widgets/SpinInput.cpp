...
SpinInput::SpinInput()
    ...
    , text_color(std::make_pair(0x6B6B6B, (int) StateColor::Disabled), std::make_pair(0x171F29, (int) StateColor::Normal))
{
    radius = 0;
    border_width     = 1;
    border_color     = StateColor(std::make_pair(0xDBDBDB, (int) StateColor::Disabled), std::make_pair(0x004fbd, (int) StateColor::Hovered),
