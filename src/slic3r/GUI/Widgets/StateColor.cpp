...
static std::map<wxColour, wxColour> gDarkColors{
    ...
    {"#004EBC", "#004fbd"}, // rgb(0, 55, 133)    Button Confirm Color hover | ORCA Color Hover
    ...
    {"#232B37", "#2D2D30"}, // rgb(59, 68, 78)     Top Bar / Main tab bar bg color
    ...
    //{"#F0F0F0", "#4C4C54"},
    // ORCA
    {"#CADAF1", "#001E45"}, // rgb(191, 225, 222)  Dropdown checked item background color > ORCA color with %25 opacity
