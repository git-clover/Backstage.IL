...
static std::map<wxColour, wxColour> gDarkColors{
    {"#004fbd", "#004fbd"}, // rgb(0, 79, 189)    ORCA color
    {"#1F8EEA", "#2778D2"}, // rgb(31, 142, 234)   ???
    {"#FF6F00", "#D15B00"}, // rgb(255, 111, 0)    Secondary color
    {"#D01B1B", "#BB2A3A"}, // rgb(208, 27, 27)    ???
    {"#171F29", "#EFEFF0"}, // rgb(38, 51, 69)     Button text color | Input Text Color
    ...
    {"#0061E9", "#003A86"}, // rgb(0, 79, 189)    Button Confirm Color hover | ORCA Color Hover
    ...
    {"#3B485B", "#2D2D30"}, // rgb(59, 68, 78)     Top Bar / Main tab bar bg color
    ...
    //{"#F0F0F0", "#4C4C54"},
    // ORCA
    {"#A9BCD8", "#223654"}, // rgb(191, 225, 222)  Dropdown checked item background color > ORCA color with %25 opacity
