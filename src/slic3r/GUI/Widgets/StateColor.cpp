...
static std::map<wxColour, wxColour> gDarkColors{
    ...
    {"#0061E9", "#008172"}, // rgb(0, 79, 189)    Button Confirm Color hover | ORCA Color Hover
    ...
    //{"#F0F0F0", "#4C4C54"},
    // ORCA
    {"#BFD3EE", "#223C3C"}, // rgb(191, 211, 238)  Dropdown checked item background color > ORCA color with %25 opacity
