...
DropDown::DropDown(std::vector<Item> &items)
    ...
    , selector_border_color(std::make_pair(0x003785, (int) StateColor::Hovered),
        std::make_pair(*wxWHITE, (int) StateColor::Normal))
    , selector_background_color(std::make_pair(0xCADAF1, (int) StateColor::Checked), // ORCA updated background color for checked item
        std::make_pair(*wxWHITE, (int) StateColor::Normal))
{
}
