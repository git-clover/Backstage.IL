...
SwitchButton::SwitchButton(wxWindow* parent, wxWindowID id)
    ...
    , thumb_color(std::pair{0x003785, (int) StateColor::Checked}, std::pair{0xD9D9D9, (int) StateColor::Normal})
{
...
ModeSwitchButton::ModeSwitchButton(wxWindow* parent, wxWindowID id)
{
    ...
    track_background = StateColor(
        std::make_pair(wxColour("#003887"), (int) StateColor::Disabled),
...
void SwitchBoard::doRender(wxDC &dc)
{
	...
	/*left*/
    if (switch_left) {
        is_enable ? dc.SetBrush(wxBrush(wxColour(0, 55, 133))) : dc.SetBrush(disable_color);
	...
	/*right*/
    if (switch_right) {
        if (is_enable) {dc.SetBrush(wxBrush(wxColour(0, 55, 133)));
        } else {dc.SetBrush(disable_color);}
...
MultiSwitchButton::MultiSwitchButton(wxWindow *parent, wxWindowID id, const wxPoint &pos, const wxSize &size, long style)
    ...
    , m_bg_color(StateColor(
          ...
          std::make_pair(0x003785, (int) StateColor::Normal)))
