...
namespace ProfileDescrption {
    ...
    const std::string PROFILE_DESCRIPTION_41 = _L("High quality profile for 0.2 mmnozzle, prioritizing print quality.");
    ...
    const std::string PROFILE_DESCRIPTION_45 = _L("Standard profile for 0.4 mmnozzle, prioritizing speed.");
    const std::string PROFILE_DESCRIPTION_46 = _L("High quality profile for 0.6 mmnozzle, prioritizing print quality and strength.");
    const std::string PROFILE_DESCRIPTION_47 = _L("Strength profile for 0.6 mmnozzle, prioritizing strength.");
    const std::string PROFILE_DESCRIPTION_48 = _L("Standard profile for 0.6 mmnozzle, prioritizing speed.");
    const std::string PROFILE_DESCRIPTION_49 = _L("High quality profile for 0.8 mmnozzle, prioritizing print quality.");
    const std::string PROFILE_DESCRIPTION_50 = _L("Strength profile for 0.8 mmnozzle, prioritizing strength.");
    const std::string PROFILE_DESCRIPTION_51 = _L("Standard profile for 0.8 mmnozzle, prioritizing speed.");
}