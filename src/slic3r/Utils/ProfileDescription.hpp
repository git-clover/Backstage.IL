...
namespace ProfileDescrption {
    ...
    const std::string PROFILE_DESCRIPTION_41 = _L("High quality profile for 0.2 mm nozzle, prioritizing print quality.");
    const std::string PROFILE_DESCRIPTION_42 = _L("High quality profile for 0.16 mm layer height, prioritizing print quality and strength.");
    const std::string PROFILE_DESCRIPTION_43 = _L("Standard profile for 0.16 mm layer height, prioritizing speed.");
    const std::string PROFILE_DESCRIPTION_44 = _L("High quality profile for 0.2 mm layer height, prioritizing strength and print quality.");
    const std::string PROFILE_DESCRIPTION_45 = _L("Standard profile for 0.4 mm nozzle, prioritizing speed.");
    const std::string PROFILE_DESCRIPTION_46 = _L("High quality profile for 0.6 mm nozzle, prioritizing print quality and strength.");
    const std::string PROFILE_DESCRIPTION_47 = _L("Strength profile for 0.6 mm nozzle, prioritizing strength.");
    const std::string PROFILE_DESCRIPTION_48 = _L("Standard profile for 0.6 mm nozzle, prioritizing speed.");
    const std::string PROFILE_DESCRIPTION_49 = _L("High quality profile for 0.8 mm nozzle, prioritizing print quality.");
    const std::string PROFILE_DESCRIPTION_50 = _L("Strength profile for 0.8 mm nozzle, prioritizing strength.");
    const std::string PROFILE_DESCRIPTION_51 = _L("Standard profile for 0.8 mm nozzle, prioritizing speed.");
}