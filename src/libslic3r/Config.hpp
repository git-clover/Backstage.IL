...
// When parsing a configuration value, if the old_value is not understood by this Backstage.IL version,
// it is being substituted with some default value that this Backstage.IL could work with.
