...
static double calc_max_layer_height(const PrintConfig &config, double max_object_layer_height)
{
    ...
    // The Prusa3D Fast (0.35 mmlayer height) print profile sets a higher layer height than what is normally allowed
...
void ToolOrdering::resolve_mixed_filaments(const PrintConfig &config)
{
    ...
    auto calc_slot_lh = [&](unsigned int ext, coordf_t print_z) -> double {
        ...
        return (lh > 0.) ? lh : 0.2;  // 0.2 mmsafety fallback; should not trigger in normal operation
    };
