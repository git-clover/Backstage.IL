var LangText = {
  en: {
    ...
    t65: "Please be aware that these plugins are not developed or maintained by Backstage.IL. They should be used at your own discretion and risk.",
  ...
  ca_ES: {
    ...
    t65: "Tingues en compte que aquests connectors no són desenvolupats ni mantinguts per Backstage.IL. S'han d'utilitzar a la teva discreció i risc.",
  ...
  es_ES: {
    ...
    t65: "Tenga en cuenta que estos complementos no están desarrollados ni mantenidos por Backstage.IL. Deben usarse bajo su propia responsabilidad.",
  ...
  it_IT: {
    t1: "Benvenuti in Backstage.IL",
    t2: "Backstage.IL verrà configurato seguendo diversi passaggi. Cominciamo!",
    t3: "Condizioni d'uso",
    t4: "Non accetto",
    t5: "Accetto",
    ...
    t52: "Salta",
    t53: "Iscriviti",
    t54: "Nella comunità di stampa 3D, impariamo dai successi e dagli insuccessi di ognuno per adattare i nostri parametri e le nostre impostazioni di slicing. Backstage.IL segue lo stesso principio, utilizzando l'apprendimento automatico per migliorare le sue prestazioni sfruttando i successi e gli insuccessi delle numerose stampe dei nostri utenti. Stiamo addestrando Backstage.IL ad essere più intelligente, fornendogli dati del mondo reale. Se lo desideri, questo servizio accederà alle informazioni dei tuoi registri di errore e di utilizzo, i quali possono includere informazioni descritte in ",
    ...
    t65: "Si prega di notare che questi moduli non sono sviluppati o mantenuti da Backstage.IL. Dovrebbero essere utilizzati a proprio rischio e discrezione.",
    ...
    t83: "2, Chiudere tutte le istanze di Backstage.IL",
    t84: "3, Eliminare tutti i file all'interno della directory del modulo",
    t85: "4, Riaprire Backstage.IL e installare nuovamente il modulo",
    t86: "Chiudi",
    t87: "Manuale d'uso",
    t88: "Rimuovi",
  ...
  fr_FR: {
    ...
    t65: "Veuillez noter que ces plugins ne sont pas développés ou maintenus par Backstage.IL. Ils doivent être utilisés à votre propre discrétion et à vos propres risques.",
  ...
  zh_CN: {
    ...
    t64: "Bambu网络插件",
    t65: "注意：这些插件不是由Backstage.IL开发或维护的。使用它们需自担风险",
    t66: "强大的远程控制功能",
    t67: "实时视频流",
    t68: "用户数据同步",
    t69: "安装Bambu网络插件",
  ...
  ru_RU: {
    ...
    t65: "Имейте в виду, что эти плагины не разрабатываются и не поддерживаются Backstage.IL. Используйте их на свой страх и риск.",
  ...
  tr_TR: {
    ...
    t65: "Lütfen bu eklentilerin Backstage.IL tarafından geliştirilmediğini veya bakımının yapılmadığını unutmayın. Kendi takdirinize ve riskinize göre kullanılmalıdırlar.",
  ...
  pl_PL: {
    ...
    t65: "Proszę mieć świadomość, że te wtyczki nie są rozwijane ani utrzymywane przez Backstage.IL. Powinny być używane na własne ryzyko i z rozwagą.",
  ...
  pt_BR: {
    ...
    t65: "Por favor seja cuidadoso estes plugins não são desenvolvidos ou mantidos por Backstage.IL. Eles devem ser usados por sua conta e risco.",
  ...
  lt_LT: {
    ...
    t65: "Atkreipkite dėmesį, kad Backstage.IL šių papildinių nesukuria ir neprižiūri. Juos turėtumėte naudoti savo nuožiūra ir rizika.",
    ...
    t85: "4, Iš naujo atverkite Backstage.IL ir iš naujo įdiekite papildinį",
    t86: "Užverti",
