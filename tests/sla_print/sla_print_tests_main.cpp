...
// /opt/prg/Backstage.IL/src/libslic3r/Format/svg.cpp:128:(.text+0x114e): undefined reference to `nsvgParseFromFile'
// /usr/bin/ld: /opt/prg/Backstage.IL/src/libslic3r/Format/svg.cpp:299:(.text+0x34d6): undefined reference to `nsvgDelete'
